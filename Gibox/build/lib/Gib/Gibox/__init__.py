...
class GExpander(GWidget):
    def __init__(self, Label: str = None, Expanded: bool = False):
        super().__init__()
        self.Init()
        from gi.repository import Gtk
        self.Widget = Gtk.Expander(expanded=Expanded, label=Label)
...
class GListBoxRow(GWidget):
    ...
    def SetActivatable(self, Activatable: bool):
        self.Widget.set_activatable(Activatable)

    def SetHeader(self, Header: GWidget):
        self.Widget.set_header(Header)

    def SetSelectable(self, Selectable: bool):
        self.Widget.set_selectable(Selectable)

    def GetActivatable(self):
        return self.Widget.get_activatable()

    def GetHeader(self):
        return Widget.get_header()

    def GetSelectable(self):
        return self.Widget.get_selectable()
...
class GListBox(GWidget):
    ...
    def Insert(self, Widget: GWidget, Position: int):
        self.Widget.insert(child=Widget, position=Position)
